    ...
    <nav className="bg-white  border-b border-gray-100 z-50 relative">
      <div className="container flex items-center justify-between mx-auto py-4 md:py-[30px]  px-5">
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link href="#" className="rounded-full opacity-60 hover:opacity-100 text-sm bg-primary px-6 py-2 text-black">
            Sign in
          </Link>

          <Link
            className={`justify-center items-center flex w-[140px] md:w-[166px] font-medium border-2  hover:bg-transparent hover:text-black duration-200 py-1.5 md:py-2.5 text-sm leading-6 text-black bg-[#ffd532] border-[#ffd532] hover:text-white' `}
            href={'#'}
          >
