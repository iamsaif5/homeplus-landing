    ...
    <footer className="bg-black pt-20 md:pt-[120px] pb-10  md:pb-[70px] mt-10 md:mt-40">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 text-sm md:text-base text-white">
          <div>
            <Link href={'/'}>
              <Image className="w-24 md:w-[130px]" src="/public/logo.png" alt="Logo" width={200} height={200} />
            </Link>
        ...
        <p className="text-[#F8F8F3] text-[10px] md:text-[12px] max-w-[800px] opacity-70 ">
          ...
          department, citing a relevant act. Include a placeholder for a license number, like "Authorized by the [State Department of
          Business Oversight] under the [State Money Transmission Act] (License No. YZ-987654)."
        </p>
      </Container>
    </footer>
  );
