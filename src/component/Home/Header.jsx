...
const Header = () => {
  return (
    <header className="relative pt-[100px] md:pt-[150px] overflow-hidden">
      ...
      <div className="absolute -top-10 inset-0 ">
        <Image src={overlay} alt="overlay" className="w-full h-full fi object-cover" />
      </div>
      ...
      <div className="relative z-10 flex h-full items-center">
        <Container>
          <div className="flex items-center flex-col">
            ...
            <Paragraph className="mb-5 md:mb-[34px] mx-auto text-center " isLight={false}>
