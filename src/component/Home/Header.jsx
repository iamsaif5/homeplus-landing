...
const Header = () => {
  return (
    <header className="relative pt-4 pb-[130px] md:pt-4 md:pb-[200px] overflow-hidden">
      <div
        className="absolute inset-0 bg-[url('/header.png')] bg-center bg-cover transform "
        aria-hidden="true"
      />
      {/* dark overlay */}
      <div className="absolute inset-0 bg-black/40" aria-hidden="true" />
      <div
        className="relative z-10 flex h-full items-start pt-0 mt-0"
        style={{ paddingTop: 0, marginTop: 0 }}
      >
        <Container>
          <div>
            <div className="font-geist-mono flex max-w-max items-center text-white gap-4 md:gap-8 bg-white/5 py-2 px-4 rounded-full text-[10px] md:text-[11px]">
              <span className="w-2 h-2  bg-white rounded-full shadow-2xl block"></span>
              <p>FREE HOME MANAGEMENT FOR UK HOMES</p>
              <svg
                width="12"
                height="12"
                viewBox="0 0 12 12"
            ...
            <Paragraph
              className="mb-5 md:mb-[34px] ml-0 mr-auto"
              isLight={true}
            >
